...
let categories = ['People', 'Nature', 'Foods', 'Activity', 'Places', 'Objects', 'Symbols', 'Flags'],
...
emojiData.sort((a, b) => {
  let aTest = a.sort_order || a.short_name, bTest = b.sort_order || b.short_name;

  return aTest - bTest;
});

emojiData.forEach(datum => {
  let category = datum.category, keywords = [], categoryIndex;
